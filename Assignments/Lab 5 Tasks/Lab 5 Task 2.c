...
int main()
{
	...
	switch(dept)
	{
	    case 1: //executed if choice is 1
		...
		switch(subdept)
		{
			...
			case 2: printf("Your chosen specialisation is AI!");break;
		...
		break;
	    case 2://executed if choice is 2
		...
		break;
		default: printf("Error! Invalid choice");//executed if choice is anything other than 1 or 2
